...
**LinkedIn public URL**
```
linkedin.com/company/143093087
```
Page created. The numeric form always resolves and redirects to the custom URL if one is set.
If you claim `accountable-mail-association` under Settings, Page info, update `community.html`
to the vanity form and change this line.
